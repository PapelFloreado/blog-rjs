  ...
  return (
    <>
      ...
      <div className='flex container mx-auto mt-16'>
        <div className='mx-4 '>
          <img className='rounded-2xl mb-4' src={vegetariano} alt="vegetariano" />
        ...
        <div className='mx-4'>
          <img className='rounded-2xl mb-4' src={salmon} alt="salmon" />
        ...
        <div className='mx-4'>
          <img className='rounded-2xl mb-4' src={carne} alt="carne" />
      ...
      <div className='flex container mx-auto mt-16'>
        <div className='mx-4'>
          <img className='rounded-2xl mb-4' src={pasta} alt="pasta" />
        ...
        <div className='mx-4'>
          <img className='rounded-2xl mb-4' src={postre} alt="postre" /> 
        ...
        <div className='mx-4'>
          <img className='rounded-2xl mb-4' src={legumbre} alt="legumbres" />
